...
const Form1 = () => {
  ...
  const {addHarvest}:any = useContext(companieContext)
  ...
  return (
    <Box bg={'white'} p={'5'} borderRadius={'5%'}>
      <Heading fontSize={"2xl"} mb={'5%'}>Cadastro da Cultura</Heading>
      <Flex flexDir={'column'} justify={'space-between'}>
        ...
        <FormControl id="ncm" mb={'5%'}>
          <FormLabel htmlFor="ncm" fontWeight={"normal"}>
            NCM
          </FormLabel>
          <Input required type="text" placeholder="Númuro NCM" {...register("ncm")}/>
        </FormControl>
