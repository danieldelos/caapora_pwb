...
const LedgerSheetFile = () => {
  ...
  const { addratio }: any = useContext(companieContext);
  ...
  const handleUpload = () => {
    ...
    addratio(formData);
    // alert("Criar o Context para o razão e integrar a rota de back_end")
  };
  ...
  return (
    ...
    >
      <FormControl mt={"3%"}>
        <FormLabel>Razão Contábil</FormLabel>
        <Input
          type="file"
          id="file-upload"
...
export default LedgerSheetFile;
